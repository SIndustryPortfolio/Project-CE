...
-- DIRECT
function NoneRaycastableModule.Initialise(NilParam, ObjectsModule, WeaponModel)
	return Initialise(WeaponModel)
end

function NoneRaycastableModule.End()
	
end

return NoneRaycastableModule