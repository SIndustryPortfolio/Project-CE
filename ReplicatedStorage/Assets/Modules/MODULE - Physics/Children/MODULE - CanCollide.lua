...
local function Initialise(_Instance, Toggle)
	-- Functions
	-- INIT
	--DebugModule:Print"CanCollide | Instance: ".. tostring(_Instance).. " | Toggle: ".. tostring(Toggle))
...
-- DIRECT
function CanCollideModule.Initialise(NilParam, _Instance, Toggle)
	return Initialise(_Instance, Toggle)
end

return CanCollideModule