...
-- DIRECT
function SlayerModule.PlayerAdded(NilParam, Player)
	return SetupPlayerConnections(Player)
end

function SlayerModule.PlayerLeft(NilParam, Player)
	return RemoveFromCache(Player)
end

function SlayerModule.Initialise()
	return Initialise()
end

function SlayerModule.End()
	return End()
end
